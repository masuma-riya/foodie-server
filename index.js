...
async function run() {
  try {
    ...
    const userCollection = client.db("foodieZone").collection("users");
    const paymentCollection = client.db("foodieZone").collection("payments");
    ...
    // menuCollection single data get
